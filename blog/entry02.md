...
* After the `enemies`, I was able to get the `Main` scene to work where the game is functioning as needed with basic features.
...
* Lastly, I added the user-interface part of the game and also learned a lot while going through this section.
 ...
 ![UI end result](../tool/UI-tutorial.png)
 
 This shows the game after adding the UI code.

 ![Main game scene](../tool/tutorial_main_scene.png)

 This shows the game after pressing the `Start` button.
